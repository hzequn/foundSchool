            ...
            <div class="section-programs">
                ...
                <div class="news-list">
                    ...
                    <ul class="clearfix">
                        ...
                        <li>
                            <a href="detail.php?type=found&l_id={$page.list[key].l_id}"><img src="{if $page.list[key].l_img}{$page.list[key].l_img}{else}../common/templates/images/wutu.jpg{/if}" alt=""></a>
                            <div class="programs-info">
                                <h2><span class="a-type1">[招领] </span><a href="detail.php?type=found&l_id={$page.list[key].l_id}" class="a-type1">{$page.list[key].l_name}</a></h2>
                                <div class="author">
                                ...
                                <div class="vote"><a href="detail.php?type=found&l_id={$page.list[key].l_id}">查看详情</a></div>
                            </div>
                        </li>
                        {/section}
                    </ul>
                    ...
                    <div class="pager">
                        ...
                        <a class="{$value.class}" href="?{$classPara}page={$value.pageIndex}">{$value.text}</a> {/foreach}
                    </div>
                    {/if} {/if}
                </div>
            </div>
