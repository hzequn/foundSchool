                ...
                success: function(data) {
                    if (data.error == 0) {
                        ...
                        for (var i = 0; i < xs.length; i++) {
                            ...
                            html = html + '<li class="vd-title" style="padding-bottom:0; font-size:14px; line-height:24px;"><h3><span class="a-type1">' + type + '</span><a href="detail.php?type=' + typepara + '&l_id=' + xs[i].l_id + '"   class="a-type2">' + xs[i].l_name + '</a><br><span class="a-type1">留言用户：</span><span class="a-type2">' + xs[i].u_name + '(' + xs[i].phone + ')</span></h3></li>';
