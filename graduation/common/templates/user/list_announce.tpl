...
<body>
    ...
    <div class="section notes">
        <div class="wrapper clearfix">
            <div class="section-notes" style="padding-left:40px;box-sizing: content-box;">
                <div class="title-bar find-hall-h1">
                    <div class="find-hall" style="padding-left:0px;">
                        公<span class="txt">告</span>大厅
                    </div>
                </div>
                <form action="" class="search-box" style="margin-top:20px;">
                    <div class="search-box">
                        <input class="search-input" type="text" name="keyword" value="{$keyword}" autocomplete="off" style="padding-left:10px;" />
                        <input class="search-submit nooutline" type="submit" value="搜索" />
                    </div>
                </form>
                    ...
                    <ul>
                        ...
                        <li class="clearfix">
                            <div class="notes-info">
                                <h2 style="color:#ffe60f;font-size: 18px;">{$page.list[key].title}</h2>
                                <p class="author">
