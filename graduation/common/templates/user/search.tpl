        ...
        <div class="wrapper">
            ...
            <div class="section-programs wrapper" style="padding-top:20px;">
                ...
                <ul class="clearfix">
                    ...
                    <li>
                        <a href="detail.php?type={if $page.list[key].type==0}lost{else}found{/if}&l_id={$page.list[key].l_id}"><img src="{if $page.list[key].l_img}{$page.list[key].l_img}{else}../common/templates/images/wutu.jpg{/if}" alt=""></a>
                        <div class="programs-info">
                            <h2><span class="a-type1">{if $page.list[key].type==0}[寻物] {else}[招领] {/if}</span><a href="detail.php?type={if $page.list[key].type==0}lost{else}found{/if}&l_id={$page.list[key].l_id}" class="a-type1">{$page.list[key].l_name}</a></h2>
                            <div class="author">
                            ...
                            <div class="vote"><a href="detail.php?type={if $page.list[key].type==0}lost{else}found{/if}&l_id={$page.list[key].l_id}">查看详情</a></div>
                        </div>
                    </li>
                    {/section}
                </ul>
                ...
                <div class="pager">
                    ...
                    <a class="{$value.class}" href="?type={$type}{$keywords}&page={$value.pageIndex}">{$value.text}</a> {/foreach}
                </div>
                {/if} {/if}
            </div>
        </div>
