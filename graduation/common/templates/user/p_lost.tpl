            ...
            <div class="step1" id="step1">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="u_name" value="{$userinfo.name}" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>手机号码</span>
                        <input type="text" name="u_phone" value="{$userinfo.phone}" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt">邮箱</span>
                        <input type="text" name="u_email" value="{$userinfo.email}" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>联系地址</span>
                        <input type="text" name="u_address" value="{$userinfo.address}" autocomplete="off" />
                    </li>
                    <li class="list">
