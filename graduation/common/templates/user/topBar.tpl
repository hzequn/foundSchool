...
<div class="section header">
    <div class="wrapper clearfix">
        ...
        <div class="main-nav fl">
            <ul>
                <li>
                    <a href="index.php" {if $title=='index' }class="on" {/if}>首页</a>
                    <span>|</span>
                </li>
                <li>
                    <a href="list_lost.php" {if $title=='list_lost' }class="on" {/if}>寻物大厅</a>
                    <span>|</span>
                </li>
                <li>
                    <a href="list_found.php" {if $title=='list_found' }class="on" {/if}>招领大厅</a>
                    <span>|</span>
                </li>
                <li>
                    <a href="p_lost.php" {if $title=='p_lost' }class="on" {/if}>发布启事</a>
                    <span>|</span>
                </li>
                <li>
                    <a href="list_announce.php" {if $title=='list_announce' }class="on" {/if}>公告大厅</a>
                    <span>|</span>
                </li>
                <li>
                    <a href="list_thank.php" {if $title=='list_thank' }class="on" {/if}>感谢信大厅</a>
                    <span>|</span>
                </li>
                <li class="last">
                    <a href="about.php" {if $title=='about' }class="on" {/if}>关于我们</a>
                </li>
            </ul>
        </div>
