                    ...
                    <table cellpadding="5" cellspacing="1">
                        ...
                        <tbody>
                            ...
                            <tr {if $smarty.section.key.index % 2==0}class="hui" {/if}>
                                <td><input type="checkbox" name=list[] data-mid="{$page.list[key].id}" data-type={if
                                ...
                                <td><a href="u_edit.php?id={$page.list[key].rl_uid}">{$page.list[key].rl_uid}</a></td>
                                <td><a href="u_edit.php?id={$page.list[key].u_id}">{$page.list[key].u_id}</a></td>
