...
?>
                            <tr <?php if ($this->_sections['key']['index'] % 2 == 0): ?>class="hui" <?php endif; ?>>
                                <td style="cursor: pointer;"><input type="checkbox" name="m[]"
                                        data-mid="<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['id']; ?>
" style="cursor: pointer;" /></td>
                                <td class="width_110"><a
                                        href="m_edit.php?id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['name']; ?>
</a></td>
                                <td class="width_200"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['phone']; ?>
</td>
                                <td class="with_230"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['email']; ?>
</td>
