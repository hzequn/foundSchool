<?php /* Smarty version 2.6.29, created on 2020-04-08 21:56:47
         compiled from admin/sideBar.tpl */ ?>
<div class="aside">
    <div class="managerinfo clearfix">
        <a href="m_edit.php"><img src="<?php if ($this->_tpl_vars['mheadImg']): ?> <?php echo $this->_tpl_vars['mheadImg']; ?>
 <?php else: ?> images/detail_avatar.jpg <?php endif; ?>" alt=""></a>
        <div class="follow-info">
            <h4><a href="m_edit.php" style="font-size: 16px;"><?php echo $this->_tpl_vars['mname']; ?>
</a></h4>
            <h5><a href="exit.php" style="background: #f7e75f;padding:5px 8px;color:#fff;">退出</a></h5>
        </div>
    </div>
