<?php /* Smarty version 2.6.29, created on 2020-04-06 21:30:54
...
?>
                        <li class="clearfix">
                            <div class="notes-info">
                                <h2 style="color:#ffe60f;font-size: 18px;"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['title']; ?>
</h2>
                                <p class="author">
