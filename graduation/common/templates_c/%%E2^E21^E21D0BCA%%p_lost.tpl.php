<?php /* Smarty version 2.6.29, created on 2020-04-11 10:07:48
 ...
 ?>
    ...
    <div class="pub-wrap">
        ...
        <form id="form" method="post" action="check_p_lost.php">
            <div class="big-title edit-lost-h1">
                <div class="edit-lost-title">编<span class="txt">辑</span>启事</div>
            </div>
            <div class="step1" id="step1">
                ...
                <ul>
                    ...
                    <li>
                        <span class="tt"><em>*</em>物品名称</span>
                        <input type="text" name="l_name" autocomplete="off" />
                    </li>
                    <li class="list">
                        <span class="tt"><em>*</em>物品类别</span>
                        <span class="items" id="field_wrap">
                    <input type="hidden" name="l_class"  value="" autocomplete="off"/>
                    ...
                    <li>
                        <span class="tt"><em>*</em>物品特征</span>
                        <input type="text" name="l_feature" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>详情描述</span>
                        <textarea name="l_desc" id="vision" autocomplete="off"></textarea>
                    </li>
                    <li>
                        <span class="tt">物品图片</span>
                        <span class="pro-pic">                   
                    <input type="hidden" name="imgpath" value="" autocomplete="off">
                    <span class="pic-wrap">
                        <img id="msg" src="../common/templates/images/wutu.jpg" /></span>
                        <span class="tip" style="width:146px;margin-left:0;">
                    建议图片尺寸370*280，格<br />式支持Jpg，图片大小不得<br />超过1M    
                    <span class="pub-btn" style="right:26px;">
                    ...
                    <li>
                        <span class="tt">丢失/拾获地点</span>
                        <input type="text" name="l_place" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>丢失/拾获时间</span>
                        <input type="text" name="l_date" onClick="WdatePicker()" autocomplete="off" />
                    </li>
                </ul>
                <div class="sub-title">
                    <h2>联系方式</h2>
                ...
                <ul>
                    <li>
                        <span class="tt"><em>*</em>姓名</span>
                        <input type="text" name="u_name" value="<?php echo $this->_tpl_vars['userinfo']['name']; ?>
" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>手机号码</span>
                        <input type="text" name="u_phone" value="<?php echo $this->_tpl_vars['userinfo']['phone']; ?>
" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt">邮箱</span>
                        <input type="text" name="u_email" value="<?php echo $this->_tpl_vars['userinfo']['email']; ?>
" autocomplete="off" />
                    </li>
                    <li>
                        <span class="tt"><em>*</em>联系地址</span>
                        <input type="text" name="u_address" value="<?php echo $this->_tpl_vars['userinfo']['address']; ?>
" autocomplete="off" />
                    </li>
                    <li class="list">
                        <span class="tt"><em>*</em>显示方式</span>
                ...
                <div class="step2" id="step2" style="display:none">
                    ...
                    <div id="person0" style="display:none;" class="person bg">
                        <ul>
                            <li>
                                <span class="tt"><em>*</em>问题：</span>
                                <textarea name="question[]" autocomplete="off"></textarea>
                            </li>
                            <li>
                                <span class="tt"><em>*</em>答案：</span>
                                <input type="text" name="answer[]" class="answer" autocomplete="off" /></li>
                            <li class="list">
                                <span class="tt"><em>*</em>答案验证模式</span>
                                <span class="items answer_wrap" id="answer0_wrap">
                    <input type="hidden" name="answer_type[]"  value=""/>
                    <a href="javascript:;" data-id='0' class="only_btn0">准确回答</a>
                    <span>（此模式下，用户答案必须与标准答案完全一致才视为正确。）</span><br>
                                <a href="javascript:;" data-id='1' class="simi_btn0">模糊匹配</a>
                                <span>（此模式下，系统将自动匹配用户答案，答案高度相似则视为正确。）</span>
                                </span>
                            </li>
                        </ul>
                        <div class="person-close">
                            <a href="javascript:"><img src="../common/templates/images/close2.png"></a>
                        </div>
                    </div>
                    <!--第一个问题-->
                    <div class="person bg">
