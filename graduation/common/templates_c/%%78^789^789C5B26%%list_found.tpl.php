<?php /* Smarty version 2.6.29, created on 2020-04-06 20:42:57
         compiled from user/list_found.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'smartTruncate', 'user/list_found.tpl', 103, false),)), $this); ?>
<!DOCTYPE html>
    ...
    <div class="section programs page-container" style="height:auto;">
        <div class="wrapper clearfix">
            <div class="section-programs">
                <h1 class="title-bar title-bar2 find-hall-h1">
                    <div class="find-hall">
                        招<span class="txt">领</span>大厅
                    </div>
                </h1>
                <div class="news-list">
                    ...
                    <p style="padding-left:20px;line-height:30px;">暂无相关启事！</p>
                    <?php else: ?>
                    <ul class="clearfix">
...
" class="a-type1"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
                                ...
                                <div class="vote"><a href="detail.php?type=found&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">查看详情</a></div>
                            </div>
                        </li>
                        <?php endfor; endif; ?>
