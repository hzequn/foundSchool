<?php /* Smarty version 2.6.29, created on 2020-04-06 20:42:56
         compiled from user/list_lost.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'smartTruncate', 'user/list_lost.tpl', 102, false),)), $this); ?>
<!DOCTYPE html>
...
" class="a-type1"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
                                ...
                                <div class="vote"><a href="detail.php?type=lost&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">查看详情</a></div>
                            </div>
                        </li>
                        <?php endfor; endif; ?>
