<?php /* Smarty version 2.6.29, created on 2020-08-02 16:15:50
...
"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['s_name']; ?>
</a>
                                </td>
...
"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['s_uname']; ?>
</a></td>
                                <td><a href="l_edit.php?type=0&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['r_id']; ?>
"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['r_name']; ?>
</a>
                                </td>
...
"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['r_uname']; ?>
</a></td>
