<?php /* Smarty version 2.6.29, created on 2020-08-02 16:15:58
...
" data-type=<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type'] == 0): ?>1<?php else: ?>0<?php endif; ?> /></td>
                                ...
                                <td><a
                                        href="l_edit.php?type=<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type'] == 0): ?>1<?php else: ?>0<?php endif; ?>&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
