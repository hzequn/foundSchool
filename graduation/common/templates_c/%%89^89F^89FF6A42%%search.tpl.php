<?php /* Smarty version 2.6.29, created on 2020-04-09 20:58:16
         compiled from user/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'smartTruncate', 'user/search.tpl', 92, false),)), $this); ?>
<!DOCTYPE html>
...
" name="sub-keywords" />
    ...
    <div class="section programs" style="height:auto;">
        <div class="wrapper">
            <h1 class="title-bar find-hall-h1">
                <div class="find-hall">
                    搜<span class="txt">索</span>结果
                </div>
            </h1>
            <div class="section-programs wrapper" style="padding-top:20px;">
                <?php if (! $this->_tpl_vars['page']['list']): ?>
...
"><img src="<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_img']): ?><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_img']; ?>
...
" class="a-type1"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
</a></h2>
                            <div class="author">
                            ...
                            <div class="vote"><a href="detail.php?type=<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type'] == 0): ?>lost<?php else: ?>found<?php endif; ?>&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">查看详情</a></div>
                        </div>
                    </li>
                    <?php endfor; endif; ?>
