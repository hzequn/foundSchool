<?php /* Smarty version 2.6.29, created on 2020-08-02 16:25:30
...
unset($_smarty_tpl_vars);
 ...
 <?php else: ?> ../common/templates/images/detail_avatar.jpg <?php endif; ?>"
                        alt=""></a>
                    <div class="follow-info">
                        <h4><?php echo $this->_tpl_vars['username']; ?>
</h4>
                        <a href="exit.php">
                            <p class="uCenter-type0">退出</p>
                        </a>
                    </div>
                </div>
                <div class="uCenter-nav">
                    <ul>
                        <li class="nav3 <?php if ($this->_tpl_vars['p'] == 'user_info' || $this->_tpl_vars['p'] == ''): ?>on<?php endif; ?>">
                            <a href="ucenter.php?p=user_info">资料设置</a>
                        </li>
                        <li class="nav2 <?php if ($this->_tpl_vars['p'] == 'reset_psw'): ?>on<?php endif; ?>">
                            <a href="ucenter.php?p=reset_psw">修改密码</a>
                        </li>
                        <li class="nav1">
                            <a href="ucenter.php?p=list">启事管理</a>
                        </li>
                    </ul>
                    <?php if ($this->_tpl_vars['p'] == 'list'): ?>
                    <ul class="sub-menu">
                        <li <?php if ($this->_tpl_vars['action'] == 'pulling' || $this->_tpl_vars['action'] == ''): ?>class="on" <?php endif; ?>><a
                                href="ucenter.php?p=list&action=pulling">匹配推送</a></li>
                        <li <?php if ($this->_tpl_vars['action'] == 'working'): ?>class="on" <?php endif; ?>><a
                                href="ucenter.php?p=list&action=working">正在发布</a></li>
                        <li <?php if ($this->_tpl_vars['action'] == 'waiting'): ?>class="on" <?php endif; ?>><a
                                href="ucenter.php?p=list&action=waiting">等待验证</a></li>
                        <li <?php if ($this->_tpl_vars['action'] == 'records'): ?>class="on" <?php endif; ?>><a
                                href="ucenter.php?p=list&action=records">历史记录</a></li>
                    </ul>
                    <?php endif; ?>
                </div>
            </div>
            <div class="uCenter-content fr">
                <div class="uCenter-follow ucenter-set">
                    ...
                    <form id="form" action="../common/uploadImg.php?type=headIcon" method="post"
                    ...
                    <form id="form2" method="post" action='reset_user.php'>
                        <div class="form-row clearfix">
                            ...
                            <input type="text" name="name" disabled="false" class="ipt-text" placeholder="请输入用户名"
                                value="<?php echo $this->_tpl_vars['userinfo']['name']; ?>
">
                        </div>
                        <div class="form-row clearfix">
...
">
                                <img class="fl" id="msg"
                                    src="<?php if ($this->_tpl_vars['userinfo']['img']): ?> <?php echo $this->_tpl_vars['userinfo']['img']; ?>
 <?php else: ?> ../common/templates/images/detail_avatar.jpg <?php endif; ?>"
                                    alt="">
                        ...
                        <div class="form-row clearfix">
                            ...
                            <input type="text" name="phone" disabled="disabled" class="ipt-text" placeholder=""
                                value="<?php echo $this->_tpl_vars['userinfo']['phone']; ?>
">
                        </div>
                        <div class="form-row clearfix">
                            <span class="tt"><em>*</em> 邮箱</span>
                            <input type="text" name="email" disabled="disabled" class="ipt-text" placeholder=""
                                value="<?php echo $this->_tpl_vars['userinfo']['email']; ?>
">
                        </div>
                        <div class="form-row clearfix">
                            <span class="tt">所在地</span>
                            <input type="text" name="address" disabled="disabled" class="ipt-text" placeholder="广东  广州"
                                value="<?php echo $this->_tpl_vars['userinfo']['address']; ?>
">
                        </div>
                        <div class="form-row clearfix">
                            <span class="tt"></span>
                    ...
                    <form id="form3" method="post">
                        ...
                        <div class="form-row clearfix">
                            ...
                            <input type="password" name="password1" disabled="disabled" class="ipt-text"
                                placeholder="请输入新密码">
                        </div>
                        <div class="form-row clearfix">
                            <span class="tt"><em>*</em> 确认密码</span>
                            <input type="password" name="password2" disabled="disabled" class="ipt-text"
...
?>
                            <li class="clearfix">
                                <a href=""><img
                                        src="<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_img']): ?><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_img']; ?>
<?php else: ?>../common/templates/images/wutu.jpg<?php endif; ?>"
                                        alt=""></a>
                                <div class="news-info">
                                    <h1
                                        style="margin-bottom:10px; font-size:20px; line-height:30px; letter-spacing:4px;">
                                        ...
                                        <a <?php if (( $this->_tpl_vars['action'] == 'pulling' || $this->_tpl_vars['action'] == '' ) && $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['state'] == 0): ?>
                                            href="checkPull.php?pull_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['pull_id']; ?>
...
"
                                            <?php elseif ($this->_tpl_vars['action'] == 'records'): ?> href='javascript:;' <?php else: ?>
                                            href="detail.php?type=<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type'] == 1): ?>lost<?php else: ?>found<?php endif; ?>&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
"
                                            <?php endif; ?> class="a-type1"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
</a><?php if (( $this->_tpl_vars['action'] == 'pulling' || $this->_tpl_vars['action'] == '' ) && $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['state'] == 0): ?>
                                        <span class="a-type2 fr">(新)</span> <?php elseif (( $this->_tpl_vars['action'] == 'records' )): ?>
                                        <span class="fr" style="font-size:16px; font-weight:lighter;">(<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_type'] == 0): ?><?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_uid'] != $this->_tpl_vars['uid']): ?>已归还<?php else: ?>已领取
                                            <span class="thank thank-btn"
                                                data-rid="<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_id']; ?>
">写感谢信</span><?php endif; ?><?php else: ?><?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_uid'] != $this->_tpl_vars['uid']): ?>已领取
                                            <span class="thank thank-btn" style="padding:10px;"
                                                data-rid="<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_id']; ?>
">写感谢信</span><?php else: ?>已归还<?php endif; ?><?php endif; ?>)</span>
                                        <?php endif; ?></h1>
                                    <h2 style="margin-bottom:10px;"><span>特征
                                            :</span><span><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_feature']; ?>
</span></h2>
...
<br>
                                        <?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_type'] == 0): ?><?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_uid'] == $this->_tpl_vars['uid']): ?>拾主<?php else: ?>失主<?php endif; ?><?php endif; ?>手机 :
                                        <?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['phone']; ?>
<br> <?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_type'] == 0): ?><?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_uid'] == $this->_tpl_vars['uid']): ?>拾主<?php else: ?>失主<?php endif; ?><?php endif; ?>地址 :
                                        <?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['address']; ?>
<br> <?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_type'] == 0): ?>认领<?php else: ?>归还<?php endif; ?>日期 :
                                        <?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_date']; ?>
</p>
                                    <?php else: ?>
                                ...
                                <span class="shade" style="display:none; padding-top:8px;">
                                    ...
                                    <p class="contact">
                                        联系人姓名：<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_name']; ?>
...
?>
                                        <p style="padding:10px 5px;">
                                            <span><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['xs'][$this->_sections['key2']['index']]['xs_date']; ?>
...
(<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['xs'][$this->_sections['key2']['index']]['phone']; ?>
                                    ...
                                    <?php endif; ?>
                                    <p class="clearfix"
                                        style="position:absolute;left:50%; top:74%; margin-left:-100px;">
                                        <?php if ($this->_tpl_vars['action'] == 'working'): ?>
                                        <a class="thank" style="margin-left:120px;text-decoration:none; color:#fff;"
                                            href="edit_lost.php?type=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type']; ?>
&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">编辑启事</a>
                                        <span class="thank showlm" style="cursor:pointer">查看线索</span> <?php elseif ($this->_tpl_vars['action'] == 'waiting' && $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['state'] == 1): ?>
                                        <span class="thank" style="margin-left:120px;">联系人信息</span> <?php elseif ($this->_tpl_vars['action'] == 'waiting' && $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['state'] == 0): ?>
                                        <span class="thank" style="margin-left:120px;">等待验证中……</span> <?php endif; ?>
                                        <a class="thank"
                                            href="detail.php?type=<?php if ($this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type'] == 1): ?>lost<?php else: ?>found<?php endif; ?>&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
"
                                            style=" text-decoration:none; color:#fff;">启事详情</a>
                                    </p>
                                    <?php if ($this->_tpl_vars['action'] == 'working'): ?>
                                    <span class="close"
                                        data-url="ajaxApi/delete_lost.php?type=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type']; ?>
&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">
...
"><?php echo $this->_tpl_vars['value']['text']; ?>
    ...
    <div class="mask">
        <div id="saying" style="padding: 10px 20px; position:fixed;">
            ...
            <input class="leave-submit" style="margin-left:80px;" type="button" id="said" data-id="171" data-type="0"
                value="提交">
    ...
    <script type="text/javascript" src="../common/templates/user/js/ucenter.js?v=2"></script>
</body>
