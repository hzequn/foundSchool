<?php /* Smarty version 2.6.29, created on 2020-04-11 11:46:32
         compiled from user/detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'user/detail.tpl', 25, false),)), $this); ?>
<!DOCTYPE html>
 ...
 ?>
    ...
    <div class="section notice">
        <div class="wrapper clearfix">
            <div class="mask"></div>
            <div class="detail">
                <div class="title-bar find-hall-h1">
                    <div class="find-hall">启<span class="txt">事</span>详情</div>
                </div>
                    ...
                    <ul class="box fl">
                        <li>
                            ...
                            <ul id="question" class="contact_info" style="display:none; padding:20px 20px;">
                                <?php if ($this->_tpl_vars['uid']): ?> <?php unset($this->_sections['key']);
...
?>
                                <li>
                                    <h3 class="q_id" data-id="<?php echo $this->_tpl_vars['question'][$this->_sections['key']['index']]['q_id']; ?>
"><?php echo $this->_tpl_vars['question'][$this->_sections['key']['index']]['question']; ?>
</h3>
                                    <input class="answer-input nooutline" type="text" value="<?php echo $this->_tpl_vars['question'][$this->_sections['key']['index']]['u_answer']; ?>
" <?php if ($this->_tpl_vars['question'][$this->_sections['key']['index']]['u_answer']): ?> disabled="disabled" <?php endif; ?>name="answer[]" style="margin-top:20px;" autocomplete="off" />
                                </li>
                                <?php endfor; endif; ?> <?php if ($this->_tpl_vars['question'][0]['u_answer']): ?>
                                <li class="clearfix" style="padding-top:10px;text-align: center">
                                    <span class="thank">答案验证中...</span>
                                    <span class="thank" style="cursor:pointer" id="cancle" />返回
                                </li>
                                <?php else: ?>
                                <li style="padding-top:10px;text-align: center">
                                    <input class="answer-submit nooutline" type="button" value="提交" id="answered" />
                                    <input class="leave-submit nooutline" type="button" value="返回" id="cancle" />
                                </li>
                                <?php endif; ?> <?php else: ?>
                                <h2>尊敬的用户，请先登陆！</h2>
                                <a class="tologin" href="login.php">去登录</a>
                                <span class="canclelogin">取消</span> <?php endif; ?>
                            </ul>
                            ...
                            <div class="checked_box" style="padding:20px; display:none;">
                                ...
                                <div style="text-align: center"><input class="leave-submit nooutline" type="button" value="好的" id="ok" data-id="<?php echo $this->_tpl_vars['list']['l_id']; ?>
...
" /><input class="leave-submit" type="button" value="返回" id="cancle-rl" /></div>
                                <div>
                                    ...
                                    <div class="contact_info" style="display:none; padding:20px 20px; padding-left:35px;">
                                        ...
                                        <div>
                                            <input class="leave-submit nooutline" style="margin-left:80px;" type="button" value="好的" id="ok" data-id="<?php echo $this->_tpl_vars['list']['l_id']; ?>
" data-type="<?php echo $this->_tpl_vars['l_type']; ?>
" />
                                            <input class="leave-submit nooutline" type="button" value="取消" id="cancle" />
                                        </div>
                                        <?php else: ?>
                                        <h2>尊敬的用户，请先登陆！</h2>
                        ...
                        <li>
                            <input class="getintouch" type="button" id="torl" value="<?php if ($this->_tpl_vars['type'] == 'lost'): ?>联系归还<?php else: ?>联系认领<?php endif; ?>" />
                            <input class="leave-submit nooutline" type="button" id="tosay" value="提供线索" />
                        </li>
                    </ul>
                    <div id="saying" style="display:none;padding:20px 20px;">
                        <?php if ($this->_tpl_vars['uid']): ?>
                        <textarea class="answer-input" name="xs_context" autocomplete="off"></textarea>
                        <input class="leave-submit nooutline" style="margin-left:80px;" type="button" id="said" data-id="<?php echo $this->_tpl_vars['list']['l_id']; ?>
" data-type="<?php echo $this->_tpl_vars['l_type']; ?>
" value="提交" />
                        <input class="leave-submit nooutline" type="button" value="取消" id="cancle-lv" /> <?php else: ?>
                        <h2>尊敬的用户，请先登陆！</h2>
                        <a class="tologin" href="login.php" style="text-decoration:none; color:#fff;">去登录</a>
                        <span class="canclelogin">取消</span> <?php endif; ?>
                    </div>
            ...
            <script type="text/javascript" src="../common/templates/user/js/detail.js?v=2.2"></script>
</body>
